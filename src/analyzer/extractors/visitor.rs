...
pub trait Visitor {
    ...
    default_extractor!(extract_yul_expr, _loc: Loc, _expr: &mut YulExpression);
    default_extractor!(extract_yul_hex_string_literal, _expr: &mut HexLiteral, _ident: &mut Option<Identifier>);
    default_extractor!(extract_yul_suffix_access, _loc: Loc, _expr: &mut YulExpression, _ident: &mut Identifier);
    default_extractor!(extract_yul_string_literal, _string_literal: &mut StringLiteral, _ident: &mut Option<Identifier>);
    ...
    default_extractor!(extract_yul_typed_ident, _ident: &mut YulTypedIdentifier);
}
