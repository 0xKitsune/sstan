...
```
    ...
    (
        ...
        "Pack Storage Variables - Gas Report",
        "
...
```
        ...
        (
            ...
            "Safe Math Post 0.8.0 - Gas Report",
            "
```solidity
...
",
        ...
        (
            ...
            "Safe Math Pre 0.8.0 - Gas Report",
            "
...
```
    ...
    (
        ...
        "Short Revert Strings - Gas Report",
        "
        ```solidity
contract GasTest is DSTest {
    Contract0 c0;
