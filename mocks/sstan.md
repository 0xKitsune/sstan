...
# Vulnerability Outcomes
 ...
 | <a name=[M-0]>[<span style="color: blue;">[M-0]</span>]</a> | <Strong>Division before multiplication</Strong> - Instances: 56 |



 | <a name=[M-1]>[<span style="color: blue;">[M-1]</span>]</a> | <Strong>Division before multiplication</Strong> - Instances: 2 |



 | <a name=[M-2]>[<span style="color: blue;">[M-2]</span>]</a> | <Strong>Division before multiplication</Strong> - Instances: 31 |
...
# Optimizations
 ...
 | <a name=[G-0]>[<span style="color: blue;">[G-0]</span>]</a> | <Strong>Use assembly when getting a contract's balance of ETH</Strong> - Instances: 1 |



 | <a name=[G-1]>[<span style="color: blue;">[G-1]</span>]</a> | <Strong>Use assembly to check for address(0)</Strong> - Instances: 7 |



 | <a name=[G-2]>[<span style="color: blue;">[G-2]</span>]</a> | <Strong>Cache array length during for loop definition.</Strong> - Instances: 8 |



 | <a name=[G-3]>[<span style="color: blue;">[G-3]</span>]</a> | <Strong>Cache Storage Variables in Memory</Strong> - Instances: 6 |



 | <a name=[G-4]>[<span style="color: blue;">[G-4]</span>]</a> | <Strong>Event is not properly indexed.</Strong> - Instances: 4 |



 | <a name=[G-5]>[<span style="color: blue;">[G-5]</span>]</a> | <Strong>Mark storage variables as `immutable` if they never change after contract initialization.</Strong> - Instances: 2 |



 | <a name=[G-6]>[<span style="color: blue;">[G-6]</span>]</a> | <Strong> `unchecked{++i}` instead of `i++` (or use assembly when applicable)</Strong> - Instances: 5 |



 | <a name=[G-7]>[<span style="color: blue;">[G-7]</span>]</a> | <Strong>Use `calldata` instead of `memory` for function arguments that do not get mutated.</Strong> - Instances: 6 |



 | <a name=[G-8]>[<span style="color: blue;">[G-8]</span>]</a> | <Strong>Use multiple require() statments insted of require(expression && expression && ...)</Strong> - Instances: 2 |



 | <a name=[G-9]>[<span style="color: blue;">[G-9]</span>]</a> | <Strong>Optimal Comparison</Strong> - Instances: 6 |



 | <a name=[G-10]>[<span style="color: blue;">[G-10]</span>]</a> | <Strong>Tightly pack storage variables</Strong> - Instances: 4 |



 | <a name=[G-11]>[<span style="color: blue;">[G-11]</span>]</a> | <Strong>Mark functions as payable (with discretion)</Strong> - Instances: 44 |



 | <a name=[G-12]>[<span style="color: blue;">[G-12]</span>]</a> | <Strong>Consider marking constants as private</Strong> - Instances: 13 |



 | <a name=[G-13]>[<span style="color: blue;">[G-13]</span>]</a> | <Strong>Avoid Reading From Storage in a for loop</Strong> - Instances: 3 |



 | <a name=[G-14]>[<span style="color: blue;">[G-14]</span>]</a> | <Strong>Use assembly to hash instead of Solidity</Strong> - Instances: 2 |



 | <a name=[G-15]>[<span style="color: blue;">[G-15]</span>]</a> | <Strong>Use assembly for math (add, sub, mul, div)</Strong> - Instances: 13 |



 | <a name=[G-16]>[<span style="color: blue;">[G-16]</span>]</a> | <Strong>Use assembly to write storage values</Strong> - Instances: 6 |



 | <a name=[G-17]>[<span style="color: blue;">[G-17]</span>]</a> | <Strong>Use custom errors instead of string error messages</Strong> - Instances: 10 |
...
# Vulnerabilities
 ...
 | <a name=[NC-0]>[<span style="color: blue;">[NC-0]</span>]</a> | <Strong>Constructor should be listed before any other function</Strong> - Instances: 1 |



 | <a name=[NC-1]>[<span style="color: blue;">[NC-1]</span>]</a> | <Strong>Private variables should contain a leading underscore</Strong> - Instances: 1 |



 | <a name=[NC-2]>[<span style="color: blue;">[NC-2]</span>]</a> | <Strong>Constructor should initialize all variables</Strong> - Instances: 13 |



 | <a name=[NC-3]>[<span style="color: blue;">[NC-3]</span>]</a> | <Strong>Consider importing specific identifiers instead of the whole file</Strong> - Instances: 157 |



 | <a name=[NC-4]>[<span style="color: blue;">[NC-4]</span>]</a> | <Strong>Constants & Immutables should be named with screaming snake case</Strong> - Instances: 6 |



 | <a name=[NC-5]>[<span style="color: blue;">[NC-5]</span>]</a> | <Strong>Consider using scientific notation for large multiples of 10</Strong> - Instances: 17 |



 | <a name=[NC-6]>[<span style="color: blue;">[NC-6]</span>]</a> | <Strong>Remove any unused functions</Strong> - Instances: 28 |



 | <a name=[NC-7]>[<span style="color: blue;">[NC-7]</span>]</a> | <Strong>Storage variables should be named with camel case</Strong> - Instances: 1 |



 | <a name=[NC-8]>[<span style="color: blue;">[NC-8]</span>]</a> | <Strong>Remove any unused returns</Strong> - Instances: 11 |
 ...
 <details open> 
 <summary> 
 <Strong>Vulnerability Outcomes</Strong> Instances(3) 
 </summary> 
 ...
 <details open> 
 <summary> 
 <Strong>Optimizations</Strong> Instances(18) 
 </summary> 
...
```
 ...
 <details open> 
 <summary> 
 <Strong>Vulnerabilities</Strong> Instances(9) 
 </summary> 
